...
class PlanSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $plans = [
            ['key' => 'esencial', 'name' => 'Esencial', 'max_patients' => 300, 'price_mxn' => 499, 'stripe_price_id' => env('STRIPE_PRICE_ESENCIAL'), 'sort_order' => 1],
            ['key' => 'crecimiento', 'name' => 'Crecimiento', 'max_patients' => 1000, 'price_mxn' => 699, 'stripe_price_id' => env('STRIPE_PRICE_CRECIMIENTO'), 'sort_order' => 2],
            ['key' => 'premium', 'name' => 'Premium', 'max_patients' => null, 'price_mxn' => 999, 'stripe_price_id' => env('STRIPE_PRICE_PREMIUM'), 'sort_order' => 3],
        ];
