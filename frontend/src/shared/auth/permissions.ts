...
export const PERMISSION_LABEL: Record<Permission, string> = {
  ...
  'quotes.manage': 'Crear y editar cotizaciones (presupuestos a pacientes)',
...
export const ROLE_DESCRIPTION: Record<Role, string> = {
  ...
  cotizaciones:
    'Crear y editar cotizaciones (presupuestos a pacientes). No registra cobros — la conversión a cobro la hace Caja.',
